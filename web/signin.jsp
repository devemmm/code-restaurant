            ...
            <div class="contain">
                ...
                <div class="row content">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="authController.do" method="POST">
                            <div class="form-group">
                                <input type="email" name="email" value="<%=authModel.getInEmail()%>" class="form-control" placeholder="Enter your Email"
                                       style="background-color: #0c0b09; color: #fff; border-color: #cda45e;" required>
                                <label><%=authModel.getEmailMsg()%></label>
                            </div><br>

                            <div class="form-group">
                                <input type="password" name="password" value="<%=authModel.getInPassword()%>" class="form-control" placeholder="Enter your password"
                                       style="background-color: #0c0b09; color: #fff; border-color: #cda45e;" required>
                            ...
                            <button class="btn btn-class" id="login" name="auth" value="Signin">Login</button><br><br>
                            <div class="signUp">
